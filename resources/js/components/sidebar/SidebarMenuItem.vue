<template>
  ...
  >
    <a href="/dashboard" class="has-text-white">
      <div class="is-flex align-items-center">
        <i style="font-size:1.8rem;" class="fa fa-bars"></i>
        <p class="ml-1" style="font-color:white;font-size:2rem;">SIM<span style="color:#f5a207">SDM</span> </p>
      </div>
    </a>
  </div>
  <div
